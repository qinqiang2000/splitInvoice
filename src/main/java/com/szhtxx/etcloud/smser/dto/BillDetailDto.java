...
public class BillDetailDto implements Serializable
{
    ...
    public Set<BillDetailIdDto> getDetailIdSet() {
        if (null == this.detailIdSet) {
            this.detailIdSet = new LinkedHashSet<BillDetailIdDto>();
            if (this.billNO != null) {
                final BillDetailIdDto detail = new BillDetailIdDto(this.billNO, this.getBillDetailNO(), this.amounts, this.price, this.amts, this.getTaxAmt());
