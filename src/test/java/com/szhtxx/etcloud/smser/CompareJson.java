...
public class CompareJson {
    public String compareJsonObject(String oldJsonStr, String newJsonStr, List<String> excludeKeys) {
        //将字符串转换为json对象
        ...
        return convertMapToJson(differenceMap, excludeKeys);
    }
     ...
     * @return
     */
    private String convertMapToJson(Map<String, Object> map, List<String> excludeKeys) {
        JSONObject resultJSONObject = new JSONObject();
        for (Map.Entry<String, Object> item : map.entrySet()) {
            String key = item.getKey();

            String[] keys = key.split("\\.");
            if (excludeKeys.contains(keys[keys.length - 1]))
                continue;
    ...
    public static void main(String[] args){
        ...
        System.out.println(new CompareJson().compareJsonObject(oldStr,newStr, Arrays.asList("123")));
    }
}
